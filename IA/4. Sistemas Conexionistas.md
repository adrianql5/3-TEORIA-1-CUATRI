...
## 8. Aprendizaje en Redes Neuronales
...
### 8.2 Algoritmo de Convergencia del Perceptrón
...
## 9. Separabilidad Lineal: Concepto Crucial

### 9.1 Clases Linealmente Separables
...
### 9.2 Clases No Linealmente Separables
...
## 10. Backpropagation: Entrenando Redes Multicapa
...
Gracias al **Deep Learning** (desde 2006), las RNA se usan en:

- 🖼️ **Visión por computador**: Reconocimiento facial, detección de objetos
- 🗣️ **Procesamiento de lenguaje**: Traducción automática, chatbots
- 🎮 **Juegos**: AlphaGo, agentes de RL
