...
## 4. Tipos de Problemas en Aprendizaje Supervisado

### 4.1 📈 Problemas de REGRESIÓN
...
### 4.2 🎯 Problemas de CLASIFICACIÓN
...
|-----------|---------------|
| Salida: **número continuo** | Salida: **categoría discreta** |
| Ejemplo: Precio = 250,350€ | Ejemplo: Clase = "Spam" |
| Pregunta: "¿Cuánto?" | Pregunta: "¿Qué tipo?" |

---

### 4.3 Importancia de las Características (Features)

**Concepto**: Aumentar el número de características **relevantes** mejora el aprendizaje.
...
## 5. REGRESIÓN LINEAL (Explicación Detallada)
...
6. **(1/2m)**: Promediamos (el ½ simplifica derivadas)
...
```
  ...
  /   ↓ bajas  \
 /      ↓       \
/________🎯_______\ ← Mínimo (mejor θ)
```
...
- ∂J/∂θⱼ: Derivada parcial (dirección del descenso)
```
