...
## 3.3 Ejemplo práctico: Ruta entre ciudades
...
**Resultado:** La distancia total recorrida puede ser mayor, por ejemplo, 240 km.
...
## 3.5 Ejemplos de heurísticas en el 8-puzzle
...
- f(n): prioridad para decidir qué nodo explorar
```

**El uso de heurísticas convierte la búsqueda en un proceso inteligente, capaz de encontrar soluciones eficientes en problemas complejos.**
