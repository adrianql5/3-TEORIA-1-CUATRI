...
En este paradigma un proceso realiza una llamada a un procedimiento de otro proceso (en otra máquina). Como siempre, los datos se pasan a través de argumentos. Cuando un proceso recibe una llamada, se ejecuta la acción codificada en ese procedimiento. Después se le informa al proceso que invocó la llamada de que invocó la llamada de que ha finalizado y si existe un valor de retorno se le envía.
...
![[Pasted image 20251012171709.png]]
